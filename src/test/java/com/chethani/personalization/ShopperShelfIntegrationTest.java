...
public class ShopperShelfIntegrationTest extends AbstractIntegrationTest {
    ...
    // Simple immutable data holder to bundle a product+score pair for building shelf request bodies.
    // record = auto-generates constructor/accessors/equals/hashCode — right fit since this only carries data, no behavior.
